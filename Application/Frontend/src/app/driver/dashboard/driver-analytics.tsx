...
function HorizontalBarChart({ distractions }: { distractions: any[] }) {
  const filtered = distractions.filter(d => !d.type.toLowerCase().includes("safe"));
  ...
  const download = () => {
    const html = `
      ...
      <body>
        ...
        <table>
          <thead><tr><th>Type</th><th>Risk Value</th><th>Duration</th></tr></thead>
          <tbody>
        ...
        <h2>Risk Trend</h2>
        <table>
          <thead><tr><th>Day / Time</th><th>Score</th></tr></thead>
          <tbody>
