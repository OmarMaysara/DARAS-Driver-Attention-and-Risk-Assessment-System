...
async def get_fleet_analysis(
    ...
    start_date: str | None = Query(None, description="Start date for range filtering"),
    end_date: str | None = Query(None, description="End date for range filtering"),
    ...
    return operations.get_fleet_wide_analysis(db, current_employer.employer_id, timeframe, target_date, threshold, start_date, end_date)
...
async def get_driver_detailed_view(
    ...
    details = operations.get_driver_detailed_dashboard(db, driver_email, current_employer.employer_id, timeframe, target_date, threshold, start_date, end_date)
    if not details: 
